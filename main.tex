...
\include{fft_based_homogenization}
\include{variational_fft}
\include{numerical_validation}
\include{numerical_results_elasticity}
\include{numerical_results_elastoplasticity}
\include{conclusions}
\appendix
\include{annex}
